...
//------------------------------------WORK ON THIS
//Adds class first before function see line284 and the replaces element with clone element
function attackClassToggle(side, player) {
    var playerElement = document.getElementById(player);
    var clonePlayerElement = playerElement.cloneNode();
    
    playerElement.parentNode.replaceChild(clonePlayerElement, playerElement);
    
}

function playerAdjacentAttack(player) {
    var playerElement = document.getElementById(player);
    var playerNumber = findPlayerNumber(player);
    var playerRow = document.getElementById(player).parentElement;
    var playerRowTiles = playerRow.querySelectorAll("td");
